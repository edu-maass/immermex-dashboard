...
def main():
    ...
    try:
        ...
        # Consulta corregida para calcular días de producción por proveedor
        calculation_sql = """
            SELECT 
                proveedor,
                ...
                AVG(
                    CASE 
                        ...
                        THEN (fecha_salida_puerto - fecha_compra)
                        ELSE NULL 
                    END
        ...
        for row in averages:
            ...
            promedio_dias = promedio.days if promedio else 0
            logger.info(f"Proveedor: {proveedor}")
            logger.info(f"  - Total registros: {total_registros}")
            logger.info(f"  - Promedio días producción: {promedio_dias}")
            ...
            try:
                ...
                for row in averages:
                    ...
                    if promedio is not None:
                        ...
                        updated_count += 1
                        logger.info(f"Actualizado proveedor: {proveedor} con promedio: {promedio_dias} días")
