"""
Script de migración corregido para manejar tipos de datos correctamente
Migra datos de tabla 'compras' a 'compras_v2' y 'compras_v2_materiales'
"""
...
def main():
    """Función principal"""
    print("MIGRACION CORREGIDA DE COMPRAS A COMPRAS_V2")
    print(f"Hora: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("="*60)
    
    try:
        # Ejecutar migración
        logger.info("Iniciando migración corregida de compras...")
