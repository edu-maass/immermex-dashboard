"""
Script para agregar columnas de fechas reales a la tabla compras_v2
"""
...
def add_real_date_columns():
    """Agrega las columnas de fechas reales a compras_v2"""
    try:
...
if __name__ == "__main__":
    print("Agregando columnas de fechas reales a compras_v2...")
    success = add_real_date_columns()
    if success:
