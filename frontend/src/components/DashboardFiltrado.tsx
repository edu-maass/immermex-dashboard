        ...
        <div className="bg-white rounded-lg shadow p-6 lg:col-span-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xl font-bold text-green-600">{formatCurrency(kpis.precio_unitario_promedio || 0)}</p>
            </div>
            
            {/* Costo Unitario */}
            <div className="text-center">
              <p className="text-sm text-gray-500 mb-1">Costo por kg</p>
              <p className="text-xl font-bold text-red-600">{formatCurrency(kpis.costo_unitario_promedio || 0)}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className={`text-xl font-bold ${(kpis.utilidad_por_kg || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {formatCurrency(kpis.utilidad_por_kg || 0)}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className={`text-xl font-bold ${(kpis.margen_por_kg || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {(kpis.margen_por_kg || 0).toFixed(1)}%
              </p>
            </div>
          </div>
        </div>
