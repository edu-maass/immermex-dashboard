...
interface ComprasV2AgingCuentasPagarChartProps {
  data: Array<{ name: string; value: number }>;
  titulo?: string;
}

export const ComprasV2AgingCuentasPagarChart: FC<ComprasV2AgingCuentasPagarChartProps> = ({
  data,
  ...
  // Definir colores por período (no usado actualmente pero mantenido para futuras mejoras)
  ...
  //   if (periodo.includes('Vencido')) return '#ef4444'; // Rojo para vencido
  //   return '#6b7280'; // Gris para otros casos
  // };
